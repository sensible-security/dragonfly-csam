<!-- Vendored from https://raw.githubusercontent.com/beercss/beercss/v4.0.23/llms.md
     Project: Beer CSS (https://github.com/beercss/beercss) — MIT License, Copyright (c) Beer CSS contributors.
     Pinned package version: beercss@4.0.23. Vendored on 2026-07-06.
     Do not edit; re-vendor via the assets:vendor task when the version pin changes. -->
